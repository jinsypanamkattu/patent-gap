  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-gray-950 py-12 md:py-16 lg:py-20">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 left-[10%] w-32 h-32 md:w-40 md:h-40 border border-emerald-500/20 rounded-full animate-float-slow" />
        <div className="absolute top-40 right-[15%] w-24 h-24 md:w-32 md:h-32 border border-emerald-400/20 rotate-45 animate-float-slower" />
            ...
            <div className="lg:col-span-12 xl:col-span-5 space-y-6 md:space-y-8 lg:space-y-10 order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4">
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center gap-2">
                    Try It Free
                    <Sparkles className="h-4 w-4 md:h-5 md:w-5 group-hover:rotate-180 transition-transform duration-500" />
                  </span>
                </button>
              </div>
            </div>
