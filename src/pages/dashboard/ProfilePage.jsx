...
import { RefreshCw, Camera, Save, Eye, EyeOff, User, Mail, Building2, Phone, Shield, Bell, Key, LogOut, ChevronRight } from 'lucide-react';
...
export default function ProfilePage() {
  ...
  const [profile, setProfile] = useState({
    firstName: auth?.user?.firstName || 'Jane',
    lastName:  auth?.user?.lastName  || 'Doe',
    email:     auth?.user?.email     || 'jane@firm.com',
    company:   auth?.user?.company   || 'IP Litigation Firm',
    phone:     auth?.user?.phone     || '',
    role:      auth?.user?.role      || 'Patent Attorney',
    bio:       auth?.user?.bio       || '',
  });
  ...
  return (
    <div className="dash-shell">
          ...
          <div className="prof-layout">
            ...
            <aside className="prof-aside">
              ...
              <div className="prof-avatar-wrap">
                ...
                <div className="prof-role-tag">{profile.role}</div>
                ...
                <div className="prof-panel">
                  ...
                  <form onSubmit={handleProfileSave}>
                    <div className="prof-form-grid">
                      ...
                      <div className="form-group">
                        <label className="form-label">Phone <span style={{ color: 'var(--ink3)', fontWeight: 400 }}>(optional)</span></label>
                        <div style={{ position: 'relative' }}>
                          <input
                            className="form-input"
                            name="phone"
                      ...
                      <div className="form-group prof-form-full">
                        <label className="form-label">Bio <span style={{ color: 'var(--ink3)', fontWeight: 400 }}>(optional)</span></label>
                        <textarea
                          className="form-input"
                          name="bio"
                          value={profile.bio}
                          onChange={handleProfileChange}
                          placeholder="A short description about your practice..."
                          rows={3}
              ...
              {activeTab === 'security' && (
                <div className="prof-panel">
                  ...
                  <div className="prof-section" style={{ marginTop: 32 }}>
                    ...
                    <div className="prof-info-list">
                      {[
                        ...
                        { label: 'Access Level',       value: 'Attorney',           badge: null },
                        ...
                        <div key={i} className="prof-info-row">
                          ...
                          <span className={`prof-info-val${row.badge ? ` badge-${row.badge}` : ''}`}>{row.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="prof-section prof-danger-section" style={{ marginTop: 32 }}>
                    ...
                    <button className="prof-danger-btn">
                      Delete Account
                    </button>
                  </div>
                </div>
      ...
      <style>{`
        ...
        /* ── Top nav responsive (mirror DashboardPage) ── */
        ...
        .prof-role-tag {
          ...
          letter-spacing: 0.10em; color: var(--accent, #2E7D32);
          background: var(--acc-soft, rgba(46,125,50,0.10));
        ...
        .prof-nav-sep {
          height: 1px; background: var(--rule, rgba(13,40,24,0.08));
          margin: 6px 4px;
        }
        ...
        .prof-saved-badge {
          ...
          letter-spacing: 0.08em; color: var(--accent, #2E7D32);
          background: var(--acc-soft, rgba(46,125,50,0.10));
        ...
        .prof-danger-btn {
          ...
          color: var(--red); border: 1.5px solid rgba(185,28,28,0.30);
        ...
        @media (max-width: 899px) {
          /* Stack layout at this breakpoint */
          .prof-layout {
        ...
        @media (max-width: 599px) {
          ...
          .prof-notif-title { font-size: 13px; }
          .prof-notif-desc { font-size: 12px; }
